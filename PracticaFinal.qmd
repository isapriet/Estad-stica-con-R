...
total_entradas <- table(airbnb$Barrio[airbnb$Barrio %in% barrios_28012])
...
```{r}
# Obtener el intervalo de confianza y el incremento en el precio por metro cuadrado extra
conf_int_metros <- confint(variable_metros)["MetrosCuadrados", ]
incremento_precio <- coef(variable_metros)["MetrosCuadrados"]

# Mostrar resultados redondeados
cat("Incremento en el precio por cada metro cuadrado extra: ", round(incremento_precio, 2), " euros.\n")
cat("Intervalo de confianza (95%) del incremento: [", round(conf_int_metros[1], 2), " a ", round(conf_int_metros[2], 2), "] euros.\n")
```
...
```{r}
# Obtener el intervalo de confianza y el incremento en el precio por habitación extra
conf_int_habitaciones <- confint(variable_dormitorio)["NumDormitorios", ]
incremento_precio_habitacion <- coef(variable_dormitorio)["NumDormitorios"]

# Mostrar resultados redondeados
cat("Incremento en el precio por cada habitación extra: ", round(incremento_precio_habitacion, 2), " euros.\n")
cat("Intervalo de confianza (95%) del incremento: [", round(conf_int_habitaciones[1], 2), " a ", round(conf_int_habitaciones[2], 2), "] euros.\n")
```
